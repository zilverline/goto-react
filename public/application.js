...
},{"./message.jsx":2,"jquery":3,"react":158}],2:[function(require,module,exports){
var React = require("react");
...
$.get("/api/messages", function(data) {
  React.render(React.createElement(Feed, {messages: data.messages}), mountNode);
});

},{"./components/feed.jsx":1,"jquery":3,"react":158}]},{},[160]);
